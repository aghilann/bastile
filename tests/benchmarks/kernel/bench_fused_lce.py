...
from bastile.ops.fused_linear_cross_entropy import fused_linear_cross_entropy as bastile_lce
from bastile.ops.fused_linear_cross_entropy import warmup_fused_lce
...
for BT in BT_sizes:
    ...
    print(f"{BT:>8} {seq_len:>8} | {fmt(t_pt)} {fmt(t_ba)} {fmt(t_lg)} | {t_ba / t_pt:>7.2f}x {t_ba / t_lg:>7.2f}x")
...
for BT in BT_sizes:
    ...
    print(
        f"{BT:>8} {seq_len:>8} | {fmt_mem(m_pt)} {fmt_mem(m_ba)} {fmt_mem(m_lg)} | "
